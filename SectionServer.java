...
public class SectionServer {
	public static void fetchSection() throws IOException, InterruptedException {
		String jsonUrl = Constants.URL_NYT_API_SECTION +Constants.URL_NYT_API_KEY;
...
//    System.out.println(response.body());
	...
	public static void insertSection() throws IOException, InterruptedException {
